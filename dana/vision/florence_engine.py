...
_log = logging.getLogger("dana.vision.florence")
...
def _resolve_device_dtype():
    ...
    try:
        from dana.middleware.resource_cap import apply_torch_vram_half_cap
...
def norm_box_to_screen(
    ...
    *,
    ...
    try:
        from dana.tracker import map_box_to_screen, primary_monitor_geometry
    except Exception:  # noqa: BLE001
