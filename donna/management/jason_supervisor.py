...
from donna.tools.slide_parser import parse_slides_in_directory
...
def shadow_run_audit_path() -> Path:
    ...
    try:
        from donna.paths import LOGS_DIR
...
def reason_slide_evaluation(
    ...
    *,
    ...
    try:
        from donna.cascade_router import reasoner_model_name
...
def build_bulk_evaluate_slides_graph(
    *,
    ...
    def _finalize(state: BulkSlideState) -> dict[str, Any]:
        ...
        try:
            from donna.memory.garbage_collector import run_blackboard_gc
...
def announce_jason_andon_override(*, block: bool = False) -> dict[str, Any]:
    ...
    try:
        ...
        from donna.ui.audio_mixer import play_jason
