...
class NavigationOperator:
    ...
    def _cursor(self) -> tuple[int, int]:
        ...
        if _dry_run():
            return self._virt_cursor
        from donna.tools.os_control import get_cursor_pos
    ...
    def _move(self, x: int, y: int) -> None:
        ...
        if _dry_run():
            return
        from donna.tools.os_control import move_cursor_absolute
    ...
    def _click(self) -> None:
        ...
        if _dry_run():
            return
        from donna.tools.os_control import click_left_sendinput
    ...
    def navigate_and_click(
        ...
        *,
        ...
        try:
            from donna.telemetry import log_operator_nav_click_complete
