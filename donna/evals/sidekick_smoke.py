...
Usage::
    ...
    python -m donna.evals.sidekick_smoke
    python -m donna.evals.sidekick_smoke --live-vision
    python -m donna.evals.sidekick_smoke --live-ocr
"""
...
def turn_chat_tool_escalation() -> list[TurnResult]:
    ...
    cases = [
        ...
        ("please read donna/paths.py and summarize it", True),
...
def turn_perception_contract_dry() -> list[TurnResult]:
    ...
    from donna.memory.blackboard import set_sensor_state, PERCEPTION_OCR_KEY, SCHEMA_OCR_V1
...
def turn_live_yolo() -> list[TurnResult]:
    ...
    from donna.memory.blackboard import read_perception_objects, read_visual_state
...
def turn_live_florence() -> list[TurnResult]:
    ...
    from donna.memory.blackboard import read_perception_ocr
...
def turn_supervisor_health() -> list[TurnResult]:
    from donna.memory.blackboard import sidekick_health
