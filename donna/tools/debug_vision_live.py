...
Examples::
    ...
    python -m donna.tools.debug_vision_live
    python -m donna.tools.debug_vision_live --save-frames
    python -m donna.tools.debug_vision_live --save-frames --fast
"""
...
from donna.operators.nav_and_click import parse_target_boxes
