...
export const PLUGINS: PluginDefinition[] = [
  ...
  },
  {
    id: "memory",
    name: "Memory",
    description: "View and edit the agent's persistent Core Memory.",
    glyph: "◈",
    accentColor: "#a78bfa",
    Component: lazy(() => import("./MemoryPlugin")),
    window: { width: 640, height: 640 },
  },
  {
    id: "skills",
    name: "Skills",
    description: "View and manage skills the agent has taught itself.",
    glyph: "✦",
    accentColor: "#fbbf24",
    Component: lazy(() => import("./SkillsPlugin")),
    window: { width: 640, height: 700 },
  },
  {
    id: "services",
    name: "Services",
    description: "Monitor, view logs for, and kill background processes the agent has started.",
    glyph: "▶",
    accentColor: "#22d3ee",
    Component: lazy(() => import("./ServicesPlugin")),
    window: { width: 900, height: 640 },
  },
  {
    id: "planner",
    name: "Planner",
    description: "See the agent's active plan for long-horizon goals, kept in sync with its own progress.",
    glyph: "☑",
    accentColor: "#c084fc",
    Component: lazy(() => import("./PlannerPlugin")),
